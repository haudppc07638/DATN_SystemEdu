                                ...
                                {["teacher", "admin"].map((role) => (
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            />
                                            <div
                                                className={`mr-4 flex h-5 w-5 items-center justify-center rounded-full border ${selectedRole === role && "border-primary"}`}
                                            >
                                                <span
                                                    className={`h-2.5 w-2.5 rounded-full bg-transparent ${selectedRole === role && "!bg-primary"}`}
                                                ></span>
                                            </div>
                                        </div>
