...
const Show = ({ departments, limit }) => {
    ...
    const confirmDelete = () => {
        router.delete(`phong-ban/${departmentIdToDelete}`);
        handleClosePopup();
    };
    ...
    const handleLimitChange = (newLimit) => {
        setData({
            ...data,
            limit: newLimit,
            page: 1 // Đặt lại trang về 1 khi thay đổi số lượng hiển thị
        });
        performSearch(); // Gọi hàm tìm kiếm sau khi thay đổi limit
    };
